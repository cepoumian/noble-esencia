...
export const Results = ({ votes, fragrances, onRetakeQuiz }: ResultsProps) => {
  ...
  return (
    ...
    >
      <div className="mb-10">
        <p className="mb-3 tracking-widest uppercase">Resultados</p>
        <h2 className="font-display mb:text-6xl mb-6 text-5xl">
          Tu recomendación personalizada
        </h2>
        <p className="mb-12 text-lg text-gray-300">
          Basado en tus respuestas, aquí están las fragancias que mejor se
          adaptan a ti:
        </p>
      </div>
